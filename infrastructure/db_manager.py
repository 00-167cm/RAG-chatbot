...
from config.settings import FIREBASE_CREDENTIAL_PATH
...
class DBManager:
    ...
    def __init__(self, credential_path: str = FIREBASE_CREDENTIAL_PATH):
        """
        Firestore接続の初期化

        Args:
            credential_path: Firebaseの認証ファイルパス。デフォルトは 'firebase-key.json'
        """
    ...
    def save_message(
        ...
        Args:
            ...
            chunks: RAG使用時の参照チャンク情報
                    [{"chunk_id": "xxx", "distance": 0.89, "source": "file.pdf"}, ...]
